...
class ArtifactBase(BaseModel):
    ...
    description: str | None = Field(None, description="文物描述")
    category: str | None = Field(None, max_length=50, description="类别")
    era: str | None = Field(None, max_length=50, description="年代")
    location: str | None = Field(None, max_length=100, description="出土地点")
    image_url: str | None = Field(None, max_length=2000, description="图片链接")
    tags: str | None = Field(None, description="标签（逗号分隔）")
    # 新增字段
    material: str | None = Field(None, max_length=50, description="材质")
    museum: str | None = Field(None, max_length=100, description="馆藏")
    source_url: str | None = Field(None, max_length=500, description="来源链接")
    dimensions: str | None = Field(None, max_length=100, description="尺寸")
...
class ArtifactUpdate(BaseModel):
    ...
    museum: str | None = Field(None, max_length=100)
