...
def chat_messages(db_session: Session, chat_session: ChatSession):
    ...
    messages = [
        ...
        ChatMessage(session_id=chat_session.id, role="assistant", content="你好！有什么可以帮您的？"),
...
class TestListSessions:
    ...
    def test_list_sessions_success(self, client: TestClient, auth_header: dict, chat_session: ChatSession):
    ...
    def test_list_sessions_pagination(self, client: TestClient, auth_header: dict, db_session: Session, test_user: User):
...
class TestGetMessages:
    ...
    def test_get_messages_success(self, client: TestClient, auth_header: dict, chat_session: ChatSession, chat_messages):
    ...
    def test_get_messages_empty_session(self, client: TestClient, auth_header: dict, db_session: Session, test_user: User):
    ...
    def test_get_messages_wrong_user(self, client: TestClient, auth_header: dict, db_session: Session):
...
class TestDeleteSessions:
    ...
    def test_delete_sessions_success(self, client: TestClient, auth_header: dict, chat_session: ChatSession):
    ...
    def test_delete_multiple_sessions(self, client: TestClient, auth_header: dict, db_session: Session, test_user: User):
