...
const exportKnowledgeGraphXlsxBuffer = async () => {
	const session = neo4jDriver.session();
	...
	try {
		...
		const filename = `knowledge-graph-${Date.now()}.xlsx`;
...
module.exports = {
	exportKnowledgeGraphXlsxBuffer,
	importKnowledgeGraphFromXlsxBuffer
};